...
module vnet 'br/CCRegistry:virtual_network:v1' = {
  scope: rgNetwork
  ...
  params: {
    ...
    location: location
    subnets: [
      { name: 'default', addressRange: '10.1.0.0/26' }
      { name: 'app', addressRange: '10.1.0.64/26' }
    ]
  }
}

module vmDemoStandard 'br/CCRegistry:windows_vm:v1' = {
  scope: rgVMs
...
module vmDemoHighPerformance 'br/CCRegistry:windows_vm:v1' = {
  scope: rgVMs
